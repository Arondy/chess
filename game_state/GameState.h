...
namespace State {
    ...
    using std::string, std::pair, std::vector, std::unordered_map, std::shared_ptr, std::thread, std::mutex, std::make_shared, std::lock_guard;
    using std::cout, std::endl;
    using Figures::Figure, Components::Player, Components::Clock, Components::GameHistory;
